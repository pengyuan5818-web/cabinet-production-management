# Generate the full abnormal test JS file
...
L("            const id = uuid(); deptIds[d.c] = id;")
...
L("            const id = uuid(); empIds.push({ id, name: e.n, dept: e.d });")
...
L("            const id = uuid(); suppIds.push({ id, name: s.n });")
...
L("            const id = uuid(); whIds.push({ id, name: w.n });")
...
L("        await client.query('BEGIN');")
L("        const orders = [")
L("            { cIdx: 0, amt: 34202.29, late: false, prio: 3 },")
L("            { cIdx: 1, amt: 26960.58, late: false, prio: 3 },")
L("            { cIdx: 2, amt: 22242.17, late: false, prio: 3 },")
L("            { cIdx: 3, amt: 42915.07, late: true, prio: 5 },")
L("            { cIdx: 4, amt: 15000.00, late: true, prio: 5 },")
L("            { cIdx: 0, amt: 0, late: false, prio: 3 },")
L("            { cIdx: 1, amt: 98765.43, late: false, prio: 5 },")
L("        ];")
